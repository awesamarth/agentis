...
export default function IdentityControls({ agent, initialParent = '', initialLabel = '', initialOperation = '' }: { agent: AgentisAgent; initialParent?: string; initialLabel?: string; initialOperation?: string }) {
  ...
  return <div className="space-y-4">
    <p className="text-base leading-relaxed text-ink-muted">ENSv2 namespace + ERC-8004 identity on Ethereum Sepolia. Wallet records enable payments on your other testnets. Identity does not grant spending permission.</p>
