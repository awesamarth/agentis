  ...
  return <section className="space-y-4">
    ...
    {query.data?.map(operation => {
      ...
      return <article className="border border-beige-darker bg-[#faf7f1] px-4 py-3" key={operation.id}>
        ...
        {operation.payment && <p className="mt-[7px] break-all font-mono text-xs">x402 · GET {operation.payment.url}</p>}
        {operation.mpp && <p className="mt-[7px] break-all font-mono text-xs">MPP · GET {operation.mpp.url}</p>}
