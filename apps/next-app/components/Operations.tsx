  ...
  return <section className="space-y-5">
    ...
    {query.data?.map(operation => {
      ...
      return <article className="border border-beige-darker bg-[#faf7f1] p-5 sm:p-7" key={operation.id}>
        ...
        {operation.payment && <p className="mt-3 break-all font-mono text-xs">x402 · GET {operation.payment.url}</p>}
        {operation.mpp && <p className="mt-3 break-all font-mono text-xs">MPP · GET {operation.mpp.url}</p>}
