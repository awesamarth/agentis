...
export const supportedNetworks = [
  ...
  { key: 'sepolia', name: 'Ethereum Sepolia (identity)', chainId: 'eip155:11155111', chainType: 'ethereum', testnet: true, currency: 'ETH', decimals: 18, priceId: 'coingecko:ethereum', assets: [{ id: 'native', symbol: 'ETH', decimals: 18, priceId: 'coingecko:ethereum' }], explorer: sepolia.blockExplorers.default.url },
] as const
