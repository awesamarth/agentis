...
- Modal UX update: setup closes on backdrop click (except while saving), holds a viewport-capped 800px height with scrollable content and a fixed footer, and permits direct Agent/Rules/Review navigation when editing. Labels now use “Per transaction” and “Testnet”. Dashboard typecheck and targeted eslint pass; authenticated browser interaction not rerun.
