...
- Ports: dashboard 3000, API 3001, **Postgres 127.0.0.1:55432** (Compose project `agentis-rewrite`, database `agentis_dev`), x402 fixture 4000, MPP fixture 4001. Migrations through `0007_grant_network_selection.sql` applied locally. Check live processes/health; don't trust historical PIDs.
